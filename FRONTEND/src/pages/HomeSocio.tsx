      ...
      <header className="p-6 pt-12 pb-4">
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center gap-4">
            <div className="size-16 rounded-full border-2 border-primary/20 p-1 bg-white dark:bg-slate-800 shadow-sm overflow-hidden flex items-center justify-center font-bold text-xl text-primary uppercase">
              {user?.foto_url ? (
