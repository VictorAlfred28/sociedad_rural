...
const PREDEFINED_OPTIONS = [
    ...
    { id: 'mercado', label: 'Mercado Agroganadero', icon: <Info size={16} />, url: 'https://www.mercadoagroganadero.com.ar/dll/hacienda1.dll/haciinfo000502', response: '¡Claro! Te estoy redirigiendo al Mercado Agroganadero...' },
    { id: 'rosgan', label: 'Rosgan', icon: <Info size={16} />, url: 'https://www.rosgan.com.ar/', response: '¡Claro! Te estoy redirigiendo a Rosgan...' },
