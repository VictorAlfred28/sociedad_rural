...
export const Chatbot: React.FC = () => {
    ...
    const handleOptionClick = (option: typeof PREDEFINED_OPTIONS[0]) => {
                            ...
                            <div className="flex flex-wrap gap-2">
                                {PREDEFINED_OPTIONS.map((option) => (
                                    <button
                                        ...
                                        className="flex items-center gap-1.5 px-3 py-1.5 bg-slate-100 hover:bg-emerald-100 hover:text-emerald-700 text-slate-600 rounded-full text-xs transition-colors border border-slate-200"
                                    >
                                        {option.icon}
                                        {option.label}
                                    </button>
